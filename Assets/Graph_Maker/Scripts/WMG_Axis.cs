...
public class WMG_Axis : WMG_GUI_Functions {
	...
	[SerializeField] private List<string> _axisLabels = default;
	...
	[SerializeField] private float _AxisMinValue = default;
	[SerializeField] private float _AxisMaxValue = default;
	[SerializeField] private int _AxisNumTicks = default;
	[SerializeField] private bool _MinAutoGrow = default;
	[SerializeField] private bool _MaxAutoGrow = default;
	[SerializeField] private bool _MinAutoShrink = default;
	[SerializeField] private bool _MaxAutoShrink = default;
	[SerializeField] private float _AxisLinePadding = default;
	[SerializeField] private bool _AxisUseNonTickPercent = default;
	[SerializeField] private float _AxisNonTickPercent = default;
	[SerializeField] private bool _HideAxisArrowTopRight = default;
	[SerializeField] private bool _HideAxisArrowBotLeft = default;
	[SerializeField] private bool _AxisArrowTopRight = default;
	[SerializeField] private bool _AxisArrowBotLeft = default;
	[SerializeField] private bool _AxisTicksRightAbove = default;
	[SerializeField] private int _AxisTick = default;
	[SerializeField] private bool _hideTick = default;
	[SerializeField] private labelTypes _LabelType = default;
	[SerializeField] private int _AxisLabelSkipStart = default;
	[SerializeField] private int _AxisLabelSkipInterval = default;
	[SerializeField] private float _AxisLabelRotation = default;
	[SerializeField] private bool _SetLabelsUsingMaxMin = default;
	[SerializeField] private int _AxisLabelSize = default;
	...
	[SerializeField] private Font _AxisLabelFont = default; 
	[SerializeField] private int _numDecimalsAxisLabels = default;
	[SerializeField] private bool _hideLabels = default;
	[SerializeField] private float _AxisLabelSpaceOffset = default;
	[SerializeField] private float _AxisLabelSpacing = default;
	[SerializeField] private float _AxisLabelDistBetween = default;
	[SerializeField] private bool _hideGrid = default;
	[SerializeField] private bool _hideTicks = default;
	[SerializeField] private bool _hideAxisLine = default;
	[SerializeField] private string _AxisTitleString = default;
	[SerializeField] private Vector2 _AxisTitleOffset = default;
	[SerializeField] private int _AxisTitleFontSize = default;
