...
public class WMG_Legend : WMG_GUI_Functions {
	...
	[SerializeField] private bool _hideLegend = default;
	[SerializeField] private legendTypes _legendType = default;
	[SerializeField] private WMG_Enums.labelTypes _labelType = default;
	[SerializeField] private bool _showBackground = default;
	[SerializeField] private bool _oppositeSideLegend = default;
	[SerializeField] private float _offset = default;
	[SerializeField] private float _legendEntryWidth = default;
	[SerializeField] private bool _setWidthFromLabels = default;
	[SerializeField] private float _legendEntryHeight = default;
	[SerializeField] private int _numRowsOrColumns = default;
	[SerializeField] private int _numDecimals = default;
	[SerializeField] private float _legendEntryLinkSpacing = default;
	[SerializeField] private int _legendEntryFontSize = default;
	[SerializeField] private float _legendEntrySpacing = default;
	[SerializeField] private float _pieSwatchSize = default;
	[SerializeField] private float _backgroundPadding = default;
	[SerializeField] private bool _autofitEnabled = default;
	[SerializeField] private Color _labelColor = default;
	[SerializeField] private FontStyle _legendEntryFontStyle = FontStyle.Normal;
	[SerializeField] private Font _legendEntryFont = default; 
