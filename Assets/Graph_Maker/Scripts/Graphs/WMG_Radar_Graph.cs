...
public class WMG_Radar_Graph : WMG_Axis_Graph {
	...
	[SerializeField] private List<Color> _dataSeriesColors = default;
	/// <summary>
	/// Colors of the series.
	/// </summary>
	public WMG_List<Color> dataSeriesColors = new WMG_List<Color>();
	[SerializeField] private List<string> _labelStrings = default;
	/// <summary>
	...
	[SerializeField] private int _numPoints = default;
	[SerializeField] private Vector2 _offset = default;
	[SerializeField] private float _degreeOffset = default;
	[SerializeField] private float _radarMinVal = default;
	[SerializeField] private float _radarMaxVal = default;
	[SerializeField] private int _numGrids = default;
	[SerializeField] private float _gridLineWidth = default;
	[SerializeField] private Color _gridColor = default;
	[SerializeField] private int _numDataSeries = default;
	[SerializeField] private float _dataSeriesLineWidth = default;
	[SerializeField] private Color _labelsColor = default;
	[SerializeField] private float _labelsOffset = default;
	[SerializeField] private int _fontSize = default;
