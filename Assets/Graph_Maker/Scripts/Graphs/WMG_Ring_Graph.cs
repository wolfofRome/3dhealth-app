...
public class WMG_Ring_Graph : WMG_Graph_Manager {
	...
	[SerializeField] public List<Color> _bandColors = default;
	/// <summary>
	...
	[SerializeField] private List<bool> _hideRings = default;
	/// <summary>
	...
	[SerializeField] private bool _bandMode = default;
	[SerializeField] private bool _pieMode = default;
	[SerializeField] private float _pieModePaddingDegrees = default;
	[SerializeField] private float _pieModeDegreeOffset = default;
	[SerializeField] private float _innerRadiusPercentage = default;
	[SerializeField] private float _degrees = default;
	[SerializeField] private float _minValue = default;
	[SerializeField] private float _maxValue = default;
	[SerializeField] private Color _bandColor = default;
	[SerializeField] public bool _autoUpdateBandAlpha = default;
	[SerializeField] private bool _autoUpdateBandAlphaReverse = default;
	[SerializeField] private Color _ringColor = default;
	[SerializeField] private float _ringWidth = default;
	[SerializeField] private float _ringPointWidthFactor = default;
	[SerializeField] private float _bandPadding = default;
	[SerializeField] private bool _hideZeroLabelLine = default;
	[SerializeField] private bool _labelStartCenteredOnBand = default;
	[SerializeField] private Vector2 _labelPointSize = new Vector2(12, 12);
	[SerializeField] private float _labelLinePadding = default;
	...
	[SerializeField] private Font _labelsFont = default; 
	[SerializeField] private bool _showDataLabels = default;
	...
	[SerializeField] private bool _antiAliasing = default;
	[SerializeField] private float _antiAliasingStrength = default;
	[SerializeField] private bool _useComputeShader = default;
