...
public class WMG_Pie_Graph : WMG_Graph_Manager {
	...
	[SerializeField] private Vector2 _leftRightPadding = default;
	[SerializeField] private Vector2 _topBotPadding = default;
	[SerializeField] private float _bgCircleOffset = default;
	[SerializeField] private bool _autoCenter = default;
	[SerializeField] private float _autoCenterMinPadding = default;
	[SerializeField] private sortMethod _sortBy = default;
	[SerializeField] private bool _swapColorsDuringSort = default;
	[SerializeField] private WMG_Enums.labelTypes _sliceLabelType = default;
	[SerializeField] private float _explodeLength = default;
	[SerializeField] private bool _explodeSymmetrical = default;
	[SerializeField] private bool _useDoughnut = default;
	[SerializeField] private float _doughnutPercentage = default;
	[SerializeField] private bool _limitNumberSlices = default;
	[SerializeField] private bool _includeOthers = default;
	[SerializeField] private int _maxNumberSlices = default;
	[SerializeField] private string _includeOthersLabel = default;
	[SerializeField] private Color _includeOthersColor = default;
	[SerializeField] private float _animationDuration = default;
	[SerializeField] private float _sortAnimationDuration = default;
	[SerializeField] private float _sliceLabelExplodeLength = default;
	[SerializeField] private int _sliceLabelFontSize = default;
	[SerializeField] private int _numberDecimalsInPercents = default;
	[SerializeField] private Color _sliceLabelColor = default;
	[SerializeField] private bool _hideZeroValueLegendEntry = default;
	[SerializeField] private bool _interactivityEnabled = default;
