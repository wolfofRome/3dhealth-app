...
public class WMG_Axis_Graph : WMG_Graph_Manager {
	...
	/// The y axis.
	/// </summary>
	[SerializeField] public WMG_Axis yAxis = default;
	/// <summary>
	/// The x axis.
	/// </summary>
	[SerializeField] public WMG_Axis xAxis = default;
	/// <summary>
	/// The secondary y axis when #axesType = DUAL_Y.
	/// </summary>
	[SerializeField] public WMG_Axis yAxis2 = default;
	...
	[SerializeField] private List<string> _groups = default;
	/// <summary>
	...
	[SerializeField] private graphTypes _graphType = default;
	[SerializeField] private orientationTypes _orientationType = default;
	[SerializeField] private axesTypes _axesType = default;
	[SerializeField] private bool _resizeEnabled = default;
	[WMG_EnumFlagAttribute] [SerializeField] private ResizeProperties _resizeProperties = default;
	[SerializeField] private bool _useGroups = default;
	[SerializeField] private Vector2 _paddingLeftRight = default;
	[SerializeField] private Vector2 _paddingTopBottom = default;
	[SerializeField] private Vector2 _theOrigin = default;
	[SerializeField] private float _barWidth = default;
	[SerializeField] private float _barAxisValue = default;
	[SerializeField] private bool _autoUpdateOrigin = default;
	[SerializeField] private bool _autoUpdateBarWidth = default;
	[SerializeField] private float _autoUpdateBarWidthSpacing = default;
	[SerializeField] private bool _autoUpdateSeriesAxisSpacing = default;
	[SerializeField] private bool _autoUpdateBarAxisValue = default;
	[SerializeField] private int _axisWidth = default;
	[SerializeField] private float _autoShrinkAtPercent = default;
	[SerializeField] private float _autoGrowAndShrinkByPercent = default;
	[SerializeField] private bool _tooltipEnabled = default;
	[SerializeField] private bool _autoAnimationsEnabled = default;
	[WMG_EnumFlagAttribute] [SerializeField] private AutoPaddingProperties _autoPaddingProperties = default;
	[SerializeField] private bool _autoPaddingEnabled = default;
	[SerializeField] private float _autoPaddingAmount = default;
	[SerializeField] private Vector2 _tickSize = default;
	[SerializeField] private string _graphTitleString = default;
	[SerializeField] private Vector2 _graphTitleOffset = default;
