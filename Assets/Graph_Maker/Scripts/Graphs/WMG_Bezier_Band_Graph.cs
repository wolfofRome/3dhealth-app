...
public class WMG_Bezier_Band_Graph : WMG_Graph_Manager {
	...
	[SerializeField] private List<Color> _fillColors = default;
	/// <summary>
	...
	[SerializeField] private Color _bandLineColor = default;
	[SerializeField] private float _startHeightPercent = default;
	[SerializeField] private int _bandSpacing = default;
	[SerializeField] private int _bandLineWidth = default;
	[SerializeField] private Vector2 _cubicBezierP1 = default;
	[SerializeField] private Vector2 _cubicBezierP2 = default;
