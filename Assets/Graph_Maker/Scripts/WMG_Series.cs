...
public class WMG_Series : MonoBehaviour {
	...
	[SerializeField] private List<Vector2> _pointValues = default;
	public WMG_List<Vector2> pointValues = new WMG_List<Vector2>();
	[SerializeField] private List<Color> _pointColors = default;
	...
	[SerializeField] private comboTypes _comboType = default;
	[SerializeField] private bool _useSecondYaxis = default;
	[SerializeField] private string _seriesName = default;
	[SerializeField] private float _pointWidthHeight = default;
	[SerializeField] private float _lineScale = default;
	[SerializeField] private Color _pointColor = default;
	[SerializeField] private bool _usePointColors = default;
	[SerializeField] private Color _lineColor = default;
	[SerializeField] private bool _UseXDistBetweenToSpace = default;
	[SerializeField] private bool _ManuallySetXDistBetween = default;
	[SerializeField] private float _xDistBetweenPoints = default;
	[SerializeField] private bool _ManuallySetExtraXSpace = default;
	[SerializeField] private float _extraXSpace = default;
	[SerializeField] private bool _hidePoints = default;
	[SerializeField] private bool _hideLines = default;
	[SerializeField] private bool _connectFirstToLast = default;
	[SerializeField] private float _linePadding = default;
	[SerializeField] private bool _dataLabelsEnabled = default;
	[SerializeField] private int _dataLabelsNumDecimals = default;
	[SerializeField] private int _dataLabelsFontSize = default;
	...
	[SerializeField] private Font _dataLabelsFont = default; 
	[SerializeField] private bool _dataLabelsAnchoredLeftBot = default;
	[SerializeField] private Vector2 _dataLabelsOffset = default;
	[SerializeField] private areaShadingTypes _areaShadingType = default;
	[SerializeField] private bool _areaShadingUsesComputeShader = default;
	[SerializeField] private Color _areaShadingColor = default;
	[SerializeField] private float _areaShadingAxisValue = default;
	[SerializeField] private int _pointPrefab = default;
	[SerializeField] private int _linkPrefab = default;
